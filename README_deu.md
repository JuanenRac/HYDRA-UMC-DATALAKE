...
Reiner Software-Dienst (Ingestion-/Analytik-Integrator) - ohne eigene Hardware/Firmware/OS, aus der Vorlage entfernt (siehe Ökosystem-Konvention in `SONNET/_papelera/`).
