...
REM *****************************************************************************
REM Project   : HYDRA-UMC-DATALAKE
REM Script    : run.bat
...
echo.
echo *****************************************************************************
echo * HYDRA-UMC-DATALAKE - run.bat
...
REM Runs HYDRA-UMC-DATALAKE's entry point. Run build.bat first.
cd /d "%~dp0"
...
python -m hydra_umc_datalake.main %*
pause
